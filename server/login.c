...
void setDefaults(){	
	...
	infoPrint("Felisberto, Sensoy & Wünsch");
infoPrint("______________________________________________________________________");
infoPrint(" _____           ______                  _____             __    ____ ");
infoPrint("/  ___|          | ___ \                |  __ \           /  |  / ___|");
infoPrint("\ `--. _   _ ___ | |_/ / __ ___   __ _  | |  \/_ __ _ __  `| | / /___ ");
infoPrint(" `--. \ | | / __||  __/ '__/ _ \ / _` | | | __| '__| '_ \  | | | ___ \");
infoPrint("/\__/ / |_| \__ \| |  | | | (_) | (_| | | |_\ \ |  | |_) |_| |_| \_/ |");
infoPrint("\____/ \__, |___/\_|  |_|  \___/ \__, |  \____/_|  | .__(_)___/\_____/");
infoPrint("        __/ |                     __/ |            | |                ");
infoPrint("       |___/                     |___/             |_|                ");
infoPrint("______________________________________________________________________");
